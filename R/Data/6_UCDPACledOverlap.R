...
huh = c(huh, "MEND: Movement for the Emancipation of the Niger Delta")

actorsDrop = c(drop, actors[!actors %in% huh])
...
#################
# save
save(yList, useActors,
     file=paste0(pathData,"ucdpActorsyList.rda") # label with acled number
)
#################