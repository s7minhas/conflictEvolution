...
\begin{enumerate}
	...
	\begin{itemize}
		\item \textcolor{blue}{ \emph{
		We thank you for pointing out this oversight. We now include a discussion of Bapat and Bond's paper in the ``Network Patterns in Intrastate Conflict'' section of the manuscript on page \emph{8}.
		}}
	\end{itemize}				
\end{enumerate}