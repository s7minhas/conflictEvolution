...
\begin{enumerate}
	...
	\begin{itemize}
		\item \textcolor{blue}{ \emph{
		We thank you for pointing out this oversight. We now discuss Bapat and Bond's paper on page XXX.
		}}
	\end{itemize}				
\end{enumerate}