...
\clearpage
\subsection{Performance under varying multiplicative effect ranks}
...
\clearpage
\subsection{TERGM Comparison}

% latex table generated in R 3.5.0 by xtable 1.8-2 package
% Fri Jul  29 19:15:11 2018
\begin{table}[ht]
\centering
\begingroup\normalsize
\begin{tabular}{lcc}
...
Intercept & -5.25 & 0.17 \\ 
   \hline
Gov-Gov Actors$_{ij}$ & 2.35 & 0.81 \\ 
  Post-Boko Haram Period$_{t}$ & 0.50 & 0.16 \\ 
  Election Year$_{t}$ & -0.10 & 0.24 \\ 
  Neighborhood Conflict$_{t}$ & -0.00 & 0.00 \\ 
  Riots/Protests$_{i,t-1}$ & 0.00 & 0.01 \\ 
  Violent Events Against Civilians$_{i,t-1}$ & 0.01 & 0.00 \\ 
  Geographic Spread$_{i,t-1}$ & 0.60 & 0.08 \\ 
  Riots/Protests$_{j,t-1}$ & -0.00 & 0.02 \\ 
  Violent Events Against Civilians$_{j,t-1}$ & 0.01 & 0.00 \\ 
  Geographic Spread$_{j,t-1}$ & 0.47 & 0.10 \\ 
  Mutuality & 1.97 & 0.40 \\ 
  GWESP (0.5) & 1.21 & 0.12 \\ 
   \hline
\hline
