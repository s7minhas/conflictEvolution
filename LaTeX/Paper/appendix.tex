...
Once I get a non-degenerate specification I will add something in. 

\clearpage
\subsection{Results when varying rank specified in AME}

Need to pull in and make some pretty chairs.

\clearpage
\subsection{Additive and Multiplicative Effects Gibbs Sampler}

\textbf{Add discussion about priors}
