...
% \begin{center}
% \textsc{Figure~\ref{fig:nigeriaNets} here}
% \end{center}

% \clearpage
\begin{figure}[ht]
	\centering
    \includegraphics[width=.7\textwidth, height = 6cm]{nigeria_postBK}
...
% \footnote{A comparison of our network model to the GLM approach can be found in the appendix.}

% \begin{center}
% \textsc{Figure~\ref{fig:abEst} here}
% \end{center}

% \clearpage
\begin{figure}[ht]
	\centering
	\includegraphics[width=.5\textwidth]{abEst2}
...
\begin{figure}[ht]
	\centering
	\begin{tabular}{cc}
	\includegraphics[width=5cm, height = 5cm]{roc_outSample} & 
	\includegraphics[width=5cm, height = 5cm]{rocPr_outSample}
	\end{tabular}
