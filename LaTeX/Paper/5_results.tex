...
\begin{figure}[ht]
	\centering
	\begin{tabular}{c}
	\includegraphics[width=.6\textwidth, height = 7cm]{betaEst} \\
	\includegraphics[width=.75\textwidth]{vcEst} \\
	\end{tabular}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=.5\textwidth, height = 6cm]{abEst2}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=1\textwidth, height =7cm]{{circPlotSimplev3}}
