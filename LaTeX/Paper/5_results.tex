...
\begin{figure}[ht]
	\centering
	\begin{tabular}{c}
	\includegraphics[width=.75\textwidth]{betaEst} \\
...
\begin{figure}[ht]
	\centering
	\begin{tabular}{cc}
	\includegraphics[width=.4\textwidth]{roc_outSampleForecast_1} & 
	\includegraphics[width=.4\textwidth]{rocPr_outSampleForecast_1}
	\end{tabular}
