...
\begin{figure}[ht]
	...
	\includegraphics[width=.7\textwidth]{vcEst} \\
	\end{tabular}
...
\begin{figure}[ht]
	\centering
    \includegraphics[width=.75\textwidth]{nigeria_postBK}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=.75\textwidth]{abEst2}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=.8\textwidth]{{circPlotSimplev3}}
