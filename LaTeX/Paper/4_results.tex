...
Finally, we examine at the effect of the Boko Haram insurgency on the level of conflict in the system and find a clear increase in violence in the years that follow Boko Haram's entry. Again this is not just the effect of Boko Haram's propensity to target and be targeted in battles, as those first order effects are accounted for in the AME model. The Boko Haram Insurgency is associated with an increase in conflicts even in the dyads that do not contain Boko Haram. 
...
What we can say is that the effect of Boko Haram demonstrates the need for a networked approach to interstate conflict. A standard approach to interstate conflict, which focuses on the government-rebel dyads, or in particularly ambitious cases, also looks at rebel-rebel dyads, would catch Boko Haram's direct effect on conflict, but it would miss this indirect effect. We show that the entrance of a group to a network increases the levels of activities even in uninvolved dyads. 
