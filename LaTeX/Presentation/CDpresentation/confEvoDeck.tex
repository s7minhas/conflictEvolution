...
\definecolor{seafoam}{RGB}{ 81, 200, 129}
...
\frame{
  \frametitle{Predicting Intrastate Conflicts}

Map of where conflicts have occurred? 
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\vspace{.2in}
 \textcolor{amaranth}{Fearon \& Laitin (2003) has been cited over 6,000 times!}
...
\frame{
  \frametitle{Conflicts are complex}
...
\frame{
	...
	\textbf{Conflict processes are driven by the evolution of relationships overtime. }
		\begin{itemize}
			\item We argue that intrastate conflicts are best understood as a single complex system composed of multiple actors in conflict with one another
			\item We conceptualize armed actors and battles as nodes and ties in a network
			\item We present a novel model that captures relationships endogenous to the conflict system, as well as covariate information at both the state and actor level. 
			\item Our model out performs standard approaches and uncovers important substantive implications for the study of conflict processes
		\end{itemize}  
